...
<style>
.hm {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/');
...
<body class="hm">
	...
	<div>
		<form class="pb-5" action="<%=ORSView.TRANSPORTATION_LIST_CTL%>"
			...
			<%
				List clist = (List) request.getAttribute("description");
			%>

			<%
				Map map = (Map) request.getAttribute("mode");
			%>
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: grey">
							...
							<th width="10%" class="text">Mode</th>
